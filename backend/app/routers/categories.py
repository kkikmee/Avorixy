...
# Все дни и слоты по умолчанию при создании категории
...
async def list_categories(
    ...
    result = await db.execute(
        ...
        .options(
            selectinload(Category.day_schedules).selectinload(DaySchedule.time_slots).selectinload(TimeSlot.tasks)
        )
...
async def create_category(
    ...
    # Автоматически создаём структуру: 7 дней × 4 слота
    for day in ALL_DAYS:
